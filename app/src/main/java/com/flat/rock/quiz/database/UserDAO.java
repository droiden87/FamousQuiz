...
public class UserDAO {
    ...
    public void addUser(User user) {
        ...
        values.put(DatabaseHelper.COLUMN_IS_CURRENT_USER, user.isCurrentUser());
    ...
    public String getUsernamebyEmail(String email) {
        String username = "";
        String rawQuery = "SELECT users.user_name FROM users WHERE users.user_email = " + "'"+ email +"'";;
    ...
    public long getUserbyId(long id) {
       long userId = 0;
        String rawQuery = "SELECT users.user_id FROM users WHERE users.user_id =  " + "'"+ id +"'";;
    ...
    public boolean isCurrentUser(boolean currentUser) {
        String where = DatabaseHelper.COLUMN_IS_CURRENT_USER+" LIKE '%"+currentUser+"%'";
        Cursor cursor = sqLiteDatabase.query(true, DatabaseHelper.TABLE_USERS, null,
    ...
    public String getPassword(){
        String password = "";
        String rawQuery = "SELECT users.user_password FROM users";
